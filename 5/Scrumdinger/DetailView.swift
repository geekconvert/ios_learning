...
struct DetailView: View {
    ...
    var body: some View {
        ...
        //Add a sheet modifier on List. When isPresentingEditView changes to true, the app presents DetailEditView using a modal sheet that partially covers the underlying content.
